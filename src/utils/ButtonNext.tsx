  ...
  return (
    <>
      <Link
        className={`${
          text === "Start!"
            ? "text-xl font-paragr rounded-md transition-all 250ms ease-in hover:bg-orange-300 px-8 py-2 bg-orangeAccent font-semibold text-black dark:text-white sm:w-[20rem] sm:text-lg"
